...
jnettop lame legit mercurial optipng p7zip pngcrush qemu recode rename rtmpdump
...
coverage rope autopep8 mccabe nose nose-progressive wheel bumpversion tox httpie"
